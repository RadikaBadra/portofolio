        ...
        <div className="container">
          ...
          <div className="flex items-center justify-between">
            <Image
              ...
              quality={100}
            />
            <span className="md:block hidden mb-3 text-white text-xs lg:text-base">
          ...
          <p className="md:hidden pt-[30px] text-center text-white text-xs">
